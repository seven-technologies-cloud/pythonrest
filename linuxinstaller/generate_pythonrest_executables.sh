...
run_command "pyinstaller --onefile --add-data '../pythonrest.py:.' --add-data '../databaseconnector:databaseconnector' --add-data '../domaingenerator:domaingenerator' --add-data '../apigenerator:apigenerator' --collect-submodules typing --collect-submodules re --collect-submodules typer --collect-submodules yaml --collect-submodules parse --collect-submodules mergedeep --collect-submodules site --collect-submodules pymysql --collect-submodules rsa --collect-submodules cryptography --collect-submodules cffi --collect-submodules pycparser --collect-submodules pyasn1 --collect-submodules psycopg2 --collect-submodules psycopg2-binary --collect-submodules pymssql ../pythonrest.py"
